...
font_option = (255, 255, 255) # RGB Color scale starts from 0 and goes upto 255
WIDTH = 800
HEIGHT = 600
center_x = WIDTH/2
center_y = HEIGHT/2
...
def draw():
    ...
    screen.clear()
    screen.blit("C:/users/daksh/My Drive/Daksh Jetlearn Work/Python_Game_Developer/images/bground.png", (0, 0))
    if game_over:
